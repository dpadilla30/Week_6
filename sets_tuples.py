...
# #you cannot access elments in a set by index because sets are unordered
# #instead you can convert the set to a list and access elments by index
# list1=list(set1)
# print(list1[0])#output: 1
# #we use sets when we wamr to store unique elments
# #and we dont care about the order of the elments
# #and do not want the elments to be changed
...
print(sample_list_of_fruit["fruits"][2])#output cherry# you can also use -1 instead of 2
...
print(sample_list_of_dicts["dicts"][2]["age"])#output 35
...
total=first_budget+second_budget
print(total)
# Define the dictionary
school = {
    "class": {
